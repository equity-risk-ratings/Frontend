...
function TradingHome() {
  ...
  return (
    <div className='TradingHome'>
      <TradeNav />
      <h3>Favorites</h3>
      <button type='button' onClick={() => setStock('MSFT')}>
        Microsoft
      </button>
      <button type='button' onClick={() => setStock('FB')}>
        Facebook
      </button>
      <button type='button' onClick={() => setStock('ATVI')}>
        Blizzard
      </button>
      <button type='button' onClick={() => setStock('SPY')}>
        Spyder
      </button>
      <button type='button' onClick={() => setStock('GOOG')}>
        Google
      </button>
      <button type='button' onClick={() => setStock('AMZN')}>
        Amazon
      </button>
      <button type='button' onClick={() => setStock('NVDA')}>
        Nvidia
      </button>
      <button type='button' onClick={() => setStock('W')}>
        Wayfair
      </button>
      <Table celled padded>
